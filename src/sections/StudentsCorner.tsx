...
const CAROUSEL_IMAGES = [
  "https://res.cloudinary.com/dnfz4jwam/image/upload/f_auto,q_auto,w_1000/v1779780063/carousel_7_cmnsyo.jpg",
  "https://res.cloudinary.com/dnfz4jwam/image/upload/f_auto,q_auto,w_1000/v1779780063/carousel_6_bzzwgo.jpg",
  "https://res.cloudinary.com/dnfz4jwam/image/upload/f_auto,q_auto,w_1000/v1779780057/carousel_8_pbze7d.jpg",
  "https://res.cloudinary.com/dnfz4jwam/image/upload/f_auto,q_auto,w_1000/v1779780053/carousel_3_hravhg.jpg",
  "https://res.cloudinary.com/dnfz4jwam/image/upload/f_auto,q_auto,w_1000/v1779780051/carousel_5_w8ffnj.jpg",
  "https://res.cloudinary.com/dnfz4jwam/image/upload/f_auto,q_auto,w_1000/v1779780053/carousel_2_vytr7u.jpg",
  "https://res.cloudinary.com/dnfz4jwam/image/upload/f_auto,q_auto,w_1000/v1779780067/carousel_1_amts2r.jpg",
];
    ...
    <section className="py-20 bg-zinc-50 border-b border-zinc-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          {/* Left Column: Noida Branch Students Gallery Card */}
          <motion.div 
          ...
          >
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-1.5 bg-brand-red/5 border border-brand-red/20 text-brand-red text-[10px] font-black uppercase tracking-widest px-3.5 py-1.5 rounded-full mb-6">
                <ImageIcon className="h-3.5 w-3.5" /> Noida Campus
              </div>

              <h3 className="text-2xl sm:text-3.5xl font-black text-zinc-900 leading-tight mb-5">
                Noida Branch Students Gallery
              </h3>
              
              <p className="text-sm sm:text-base text-zinc-500 leading-relaxed font-semibold">
                The most profound Digital Marketing Course in Noida is specially designed for Businessmen, JobSeekers, and Students to help them grow in their careers. The center is designed in a way that suits your learning needs.
              </p>
            </div>
