      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-zinc-50 border border-zinc-200 rounded-3xl p-8 sm:p-10 text-center max-w-4xl mx-auto shadow-sm relative overflow-hidden">
          ...
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-black tracking-tight mb-2 uppercase leading-snug text-zinc-800">
            MASTER IN DIGITAL MARKETING COURSE <span className="text-brand-red">IN NOIDA</span>
          </h3>
          ...
          <p className="text-sm sm:text-base font-semibold text-zinc-500 leading-relaxed max-w-3xl mx-auto">
            The main reasons to join digital marketing training program in Noida. In DIDM Noida training centre, you will get both <span className="font-extrabold text-zinc-800">In-Class</span> and <span className="font-extrabold text-zinc-800">Online</span> digital marketing training sessions. DIDM Noida covers almost <span className="font-extrabold text-brand-red">50+ digital marketing modules</span> specially designed to fulfill the market needs.
          </p>
