      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16 flex flex-col gap-3">
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight leading-tight text-zinc-800 uppercase">
            DIGITAL MARKETING COURSE COMPARISON <span className="text-brand-red">- NOIDA</span>
          </h2>
          <p className="text-sm sm:text-base font-semibold text-zinc-550 max-w-3xl mx-auto leading-relaxed">
            The Best Digital Marketing Institute in Noida, DIDM provides a detailed evaluation of three diverse digital marketing courses offered by DIDM in the Noida region. Compare features, modules, and benefits to select the ideal program tailored to your career aspirations in digital marketing.
          </p>
