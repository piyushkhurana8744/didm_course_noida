      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-14 flex flex-col items-center gap-4">
          ...
          >
            ...
            Institute in <span className="bg-gradient-to-r from-red-500 to-rose-600 bg-clip-text text-transparent">Noida</span>
          </motion.h2>
          ...
          >
            NOIDA is located in the Gautam Budh Nagar of Uttar Pradesh. Noida is famous for big company hub like HCL, TCS, Wipro, Media Houses and Many MNC&apos;s company operated in Noida. Many People come across India at Noida for looking Jobs. Noida always come in first place to create lots of jobs opportunities in every sector. Delhi Institute of Digital Marketing (DIDM) located at F-23 Film City News 24 Office premises. ISOMES-NEWS24 is our training partner. DIDM Noida provide best quality of digital marketing training and same time also provide internships and placement opportunities to our Students so that they get real time exposure to work with News24 platform.
          </motion.p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch max-w-5xl mx-auto">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="text-left bg-zinc-50/50 rounded-2xl border border-zinc-150 p-4 flex flex-col gap-2.5">
                <p className="text-sm sm:text-base font-bold text-zinc-800 leading-snug">
                  S-2, 2nd Floor, Savitri Market, Noida
                </p>
                ...
                <div className="flex flex-wrap items-center gap-1.5 text-xs font-semibold border-t border-zinc-200/60 pt-2.5">
                  ...
                  <a
                    href="https://www.google.com/search?q=DIDM+Noida+reviews"
                    target="_blank"
                    rel="noreferrer"
          ...
          >
            ...
            <div className="mt-6 relative group/btn">
              ...
              <Button
                onClick={() => onOpenDemo?.("Noida Training Course")}
