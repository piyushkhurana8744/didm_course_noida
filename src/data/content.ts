...
export const HIGHLIGHTS_DATA: HighlightItem[] = [
  ...
  },
  {
    ...
    description: "Top performers get guaranteed 3-month agency internships at Noida’s top performance marketing firms.",
    icon: "Users",
...
export const WHY_CHOOSE_US_DATA: HighlightItem[] = [
  ...
  },
  {
    ...
    description: "Attend high-tech offline classes at our premium Noida campus or join live online sessions with HD recordings.",
    icon: "Laptop",
    color: "red"
  },
  {
...
export const CURRICULUM_DATA: CourseCurriculum[] = [
  {
    ...
    modules: [
      ...
      },
      {
        ...
        description: "Earning premium authority backlinks, executing blogger outreach, and claiming Local 3-Pack rankings in Noida search queries."
      }
    ]
  },
  {
...
export const TESTIMONIALS_DATA: Testimonial[] = [
  {
    ...
    company: "Dentsu Aegis Network, Noida",
...
export const PLACEMENTS_DATA: PlacementCard[] = [
  ...
  },
  {
    ...
    companyName: "Amazon Noida Campus",
...
export const FAQ_DATA: FAQItem[] = [
  {
    question: "Where is DIDM located in Noida?",
    answer: "The Delhi Institute of Digital Marketing (DIDM) Noida is located at Gate No-2, S-2, 2nd Floor, Savitri Market Sector-18 Metro Station Sec-18, Noida, Uttar Pradesh 201301. The nearest metro station from DIDM's Digital Marketing Institute in Noida is Noida Sector-18 Metro Station."
  },
  {
    question: "What are the benefits of doing digital marketing training in Noida?",
    answer: "After completing your digital marketing training in Noida, you will find lots of opportunities in the field of digital marketing. Trained experts with skills such as SEO, SMO, Google Ads, Email Marketing, etc. are in high demand by many multinational companies in Noida. Job portals like Naukri.com and Monster.com are flooded with job openings in the field of Digital Marketing in the Noida Region."
  },
  {
    question: "What is the duration of the digital marketing course in Noida?",
    answer: "The course length of DIDM's digital marketing course in Noida is 3 to 6 months, depending on which batch you enrol in (regular or weekend). We also provide assignments and have you work on live projects."
  },
  {
  ...
  },
  {
    ...
    answer: "Our digital marketing training in Noida is available in both online and offline formats. You can choose the one that best suits your needs. Our online digital marketing training in Noida is conducted through a Learning Management System (LMS)."
  },
  {
    question: "What are the salary packages for digital marketing jobs in Noida?",
    answer: "According to Ambition Box, the average annual salary of a digital marketer in Noida is 4.8 lakhs. This figure increases with experience and expertise."
  },
  {
    question: "Is Digital Marketing a good career choice?",
    answer: "Digital Marketing is a fantastic career choice. The rise of digital marketing has resulted in an increased demand for skilled digital marketers, and this demand is only growing. Anyone who wants to pursue a career in digital marketing has a bright future. Our digital marketing institute in Noida is dedicated to bridging the gap between the demand and supply of skilled digital marketers in Noida."
  },
  {
    question: "Should I take the entire course, or should I opt for modules that I want to specialize in?",
    answer: "Our Master in Digital Marketing and Advanced Digital Marketing Course in Noida provides you with a complete and in-depth knowledge of digital marketing. However, if you are only interested in learning about one or two specific aspects of digital marketing, you can choose to enrol in our Professional in Digital Marketing Course. This course allows you to choose the modules that you are most interested in and specialize in them."
  },
  {
    question: "Which is the best digital marketing institute in Noida?",
    answer: "The best digital marketing institute in Noida is the one that puts its trainees' success first. DIDM Noida is the best digital marketing institute in Noida for a lot of reasons. Here are some of the benefits that DIDM provides to its trainees that make it the best digital marketing institute in Noida: 50+ Advanced and Updated Modules, 100% Practical Training Sessions, Tools and Software Support, Industry Expert Trainers, 100% Placement Assistance, Training Supported with LMS, Excellent Student Career Support, 30+ Globally Recognized Certifications, and Add-on Training on Content Writing and Graphic Designing."
  },
  {
    question: "What career opportunities will I have after I complete my digital marketing course in Noida?",
